package certiware.search.naver;
...
public class NaverSearch {
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<JSONArray> itemsList = new ArrayList<>();
        ...
        for (int i = 0; i < diseaseCode_14.length; i++) {
            ...
            String apiURLBlog = "https://openapi.naver.com/v1/search/blog.json?query=" + text + "&sort=date&display=3";    // JSON 결과 size() 때문에 +1 해서 검색할 것
...
//        System.out.println("items:"+items);
        System.out.println("-----------------------------------");
        System.out.println("for문 밖 items=itemsList:"+itemsList);    // items 정보를 담아둔 리스트 itemsList
        System.out.println("-----------------------------------");
        System.out.println("itemsList.get(0):"+itemsList.get(0));
...
//            JSONArray itemsArray = itemsList.get(i);
//            JSONObject itemsObject = (JSONObject) itemsArray.get(i);
//
//            System.out.println("-----------------------------------");
//            System.out.println("itmesObject:"+itemsObject);
//
...
//                cell.setCellValue("Y");
//
//                System.out.println("tiem:"+itemsObject.get("postdate").toString());
//            }
//        }
//        try {
//            File xlsFile = new File("/Users/misonaru/Desktop/" + texts + "_" + datetime + ".xls");
//            File xlsFile = new File("/Users/misonaru/Desktop/test.xls");
